...
public class Presentation {
	...
	@Autowired
	public Presentation(ServiceInf y) {
		System.out.println("presnetation created and service wired");
		serviceInf = y;//what is relationship between Presentation and ServiceInf
	}
	...
	private void insertLogic() {
		...
		CUser user =new CUser("ant","deer","virus@ele.com",8765);   
